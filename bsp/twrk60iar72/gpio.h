...
#define TRACE_KUART			UART5_BASE_PTR

#define TRC_MUX_PPTY		(PORT_MUX_ALT3)
#define CFGIO_TRC_RXD()		KPRPH(E, 9, TRC_MUX_PPTY,1)
#define CFGIO_TRC_TXD()		KPRPH(E, 8, TRC_MUX_PPTY,1)
#define CFGIO_TRC_RTS()		KPRPH(E, 11, TRC_MUX_PPTY,1)
#define CFGIO_TRC_CTS()		KPRPH(E, 10, TRC_MUX_PPTY,1)
